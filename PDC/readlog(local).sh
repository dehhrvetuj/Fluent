...
#   set xrange [4779:5100]
	...
	plot for [col=2:$num] "< ssh congwang@dardel.pdc.kth.se 'cat /cfs/klemming/home/c/congwang/$1'  | grep -E  '$rexp' "  using 1:col title word(titles,col) with lines
